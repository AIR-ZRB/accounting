<template>
    <div>
        <header class="settingHeaderPage">
            <svg
                @click="goBack"
                class="icon icon-left"
                style="left: 10px;vertical-align: middle;fill: currentColor;overflow: hidden;"
            ...
            <svg
                @click="setting"
                class="icon icon-right icon-setting"
                style="right: 10px;vertical-align: middle;fill: currentColor;overflow: hidden;"
                viewBox="0 0 1024 1024"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
                p-id="620"
        ...
        <div class="editBg" v-if="editShow">
         ...
         <!-- <div class="editImg" id="editImg" v-show="false" ref="editImg">
            <span>确定</span>
        </div>
 -->
